...
**1943 tests, 0 failed, 4 skipped** (surefire, summed over the reactor).
...
| `libs/openid-federation` | 117 | green | 94% | 415 |
| `libs/agent-registry` | 7 | green | 92% | 25 |
| `servlets/pf-integration` | 98 | green | 80% | 405 |
...
**349 methods gated across the reactor, all green.**
...
**413 distinct requirements pinned by 830 tests.**

**189 of 196 conformance-matrix rows are pinned by a test.** The
