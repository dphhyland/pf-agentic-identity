...
**2160 tests, 0 failed, 4 skipped** (surefire, summed over the reactor).
...
| `servlets/pf-integration` | 151 | green | 86% | 504 |
...
**494 methods gated across the reactor, all green.**
...
**464 distinct requirements pinned by 954 tests.**
