...
**2055 tests, 0 failed, 4 skipped** (surefire, summed over the reactor).
...
| `libs/openid-federation` | 175 | green | 96% | 498 |
| `libs/agent-registry` | 7 | green | 92% | 25 |
| `servlets/pf-integration` | 114 | green | 81% | 434 |
...
**423 methods gated across the reactor, all green.**
...
**455 distinct requirements pinned by 907 tests.**

**202 of 209 conformance-matrix rows are pinned by a test.** The
