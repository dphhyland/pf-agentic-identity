...
**2183 tests, 0 failed, 4 skipped** (surefire, summed over the reactor).
...
| `servlets/pf-integration` | 167 | green | 87% | 526 |
...
**511 methods gated across the reactor, all green.**
...
**466 distinct requirements pinned by 971 tests.**
