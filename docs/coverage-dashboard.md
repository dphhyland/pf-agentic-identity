...
**1103 tests, 0 failed, 4 skipped** (surefire, summed over the reactor).
...
| `libs/client-attestation` | 8 | green | 77% | 96 |
| `libs/openid-federation` | 7 | green | 65% | 111 |
| `libs/agent-registry` | 7 | green | 92% | 25 |
| `servlets/pf-integration` | 7 | green | 49% | 103 |
| `servlets/attestation-issuer` | 13 | green | 83% | 195 |
| `servlets/ssf` | 16 | green | 65% | 134 |
| `plugins/rar-paz-plugin` | 2 | green | 75% | 53 |
