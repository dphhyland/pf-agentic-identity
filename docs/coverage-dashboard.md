...
**2172 tests, 0 failed, 4 skipped** (surefire, summed over the reactor).
...
| `libs/openid-federation` | 209 | green | 97% | 533 |
| `libs/agent-registry` | 7 | green | 92% | 25 |
| `servlets/pf-integration` | 158 | green | 87% | 516 |
...
**501 methods gated across the reactor, all green.**
...
**464 distinct requirements pinned by 963 tests.**
