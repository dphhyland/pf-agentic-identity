...
**2021 tests, 0 failed, 4 skipped** (surefire, summed over the reactor).
...
| `libs/openid-federation` | 160 | green | 95% | 473 |
| `libs/agent-registry` | 7 | green | 92% | 25 |
| `servlets/pf-integration` | 111 | green | 81% | 425 |
...
**405 methods gated across the reactor, all green.**
...
**440 distinct requirements pinned by 888 tests.**

**197 of 204 conformance-matrix rows are pinned by a test.** The
